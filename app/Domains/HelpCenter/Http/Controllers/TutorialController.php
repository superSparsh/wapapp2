...
class TutorialController extends Controller
{
    ...
    public function stream(string $filename, TutorialModuleTree $moduleTree): StreamedResponse
    {
        $filename = basename(rawurldecode($filename));
        $path = $moduleTree->resolveLocalVideoPath($filename);
