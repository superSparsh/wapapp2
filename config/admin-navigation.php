...
return [
    ...
    [
        ...
        'children' => [
            ...
            ['label' => 'Recharge / credit requests', 'route' => 'admin.recharge-requests.index', 'matches' => []],
            ['label' => 'Wallet Recharges', 'route' => 'admin.wallet-recharges.index', 'matches' => []],
            ['label' => 'Zoho credits', 'route' => 'admin.zoho-credits.index', 'matches' => ['admin.zoho-credits.show']],
    ...
    [
        ...
        'children' => [
            ...
            ['label' => 'Country pricing', 'route' => 'admin.pricing.index', 'matches' => ['admin.pricing.*']],
            ['label' => 'Pricing change logs', 'route' => 'admin.pricing.logs', 'matches' => []],
    ...
    [
        ...
        'icon' => 'star',
        'matches' => ['admin.settings.*', 'admin.maintenance.*'],
        'children' => [
            ['label' => 'All settings', 'route' => 'admin.settings.index', 'matches' => []],
            ['label' => 'Maintenance mode', 'route' => 'admin.maintenance.edit', 'matches' => []],
