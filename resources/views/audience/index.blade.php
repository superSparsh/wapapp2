          ...
          <tr class="bg-elevated">
            ...
            <td class="w-[240px] p-2">
              <div class="flex items-center justify-center gap-6">
                ...
                <button type="button" data-open-modal="import-subscribers" data-mail-list-id="{{ $list->uuid }}" data-mail-list-name="{{ $list->name }}" class="flex size-5 items-center justify-center" aria-label="Import subscribers">
