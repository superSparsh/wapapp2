  ...
  <div class="flex flex-col bg-surface">
    <div class="flex flex-col gap-4 p-4">
      <div class="flex flex-col gap-1">
        ...
        <p class="fd-page-note">Manage your bulk messaging campaigns.</p>
      </div>
        ...
        >
          <x-slot:filters>
            ...
            >
              ...
              @foreach (\App\Enums\CampaignStatus::cases() as $statusEnum)
    ...
    <section class="p-4 pt-0">
      @if ($campaigns->isEmpty())
        <div class="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-elevated p-12">
          <p class="text-sm font-medium text-text-subtle">No campaigns found.</p>
