...
<x-inbox.modal id="ask-for-address" :title="$modal['title']" :subtitle="$modal['subtitle']" :open="$open ?? false">
    <x-inbox.modal-form>
        <form class="flex flex-col gap-8">
            <div class="flex flex-col gap-2">
                ...
                <textarea
                    rows="2"
                    id="address_message_body"
                    placeholder="e.g., 'please share Delivery Address'"
            ...
            <div class="flex flex-col gap-2">
                ...
                <textarea
                    rows="2"
                    id="address_footer_text"
                    placeholder="e.g., 'Needed for Shipping'"
                    class="h-20 w-full resize-none rounded-xl border border-border bg-elevated p-3 text-sm font-medium leading-[1.4] placeholder:text-text-muted focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
                    style="font-family: var(--font-display)"
                ></textarea>
            </div>

            <x-inbox.modal-actions submit="Create Address Message" />
        </form>
    </x-inbox.modal-form>
