@php
  ...
  $menuItems = [
    ...
    ['modal' => null, 'label' => 'Send opt-in', 'image' => 'ask-questions.png', 'requires_window' => false, 'action' => 'opt-in'],
    ['modal' => 'request-payment', 'label' => 'Request Payment', 'image' => 'request-payment.png', 'requires_window' => false],
