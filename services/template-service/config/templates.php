...
return [
    ...
    'header_image_max' => (int) env('TEMPLATE_HEADER_IMAGE_MAX', 5242880),
    'header_video_max' => (int) env('TEMPLATE_HEADER_VIDEO_MAX', 16777216),
    'header_document_max' => (int) env('TEMPLATE_HEADER_DOC_MAX', 10485760),
    'header_audio_max' => (int) env('TEMPLATE_HEADER_AUDIO_MAX', 16777216),

    // Template categories in builder
    'categories' => [
        'MARKETING',
        'UTILITY',
        'AUTHENTICATION',
    ...
    // Languages
    'languages' => [
        'en_GB', 'en_US', 'hi_IN', 'af_ZA', 'ar_AR', 'az_AZ', 'bn_BD', 'bn_IN', 'de_DE',
        'es_AR', 'es_ES', 'es_MX', 'fr_FR', 'gu_IN', 'id_ID', 'it_IT', 'ja_JP', 'kn_IN',
        'ko_KR', 'ml_IN', 'mr_IN', 'ms_MY', 'nl_NL', 'pa_IN', 'pl_PL', 'pt_BR', 'pt_PT',
        'ru_RU', 'sk_SK', 'ta_IN', 'te_IN', 'th_TH', 'tr_TR', 'uk_UA', 'ur_IN', 'ur_PK',
        'vi_VN', 'zh_CN', 'zh_TW'
    ],
